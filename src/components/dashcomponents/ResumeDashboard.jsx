...
const HalfCard = ({ className = "", children }) => (
  <div className={`rounded-lg w-full lg:w-1/2 border dark:border-none bg-card text-card-foreground shadow-sm ${className}`}>
    {children}
  </div>
);
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Certifications */}
        {data.certifications && data.certifications.length > 0 && renderSection("Certifications",
        ...
        {data.extracurricular && data.extracurricular.length > 0 && renderSection("Extracurricular Activities",
          <ul className="space-y-2">
