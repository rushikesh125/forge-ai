...
const JobSuggestions = () => {
  ...
  return (
    <>
      ...
      {!suggestions && <div className="w-full p-2 text-center justify-center border border-dashed border-red-500 text-red-500 dark:border-red-100 rounded-lg my-3 flex dark:text-red-200"><ShieldAlert/> No Job Suggestions Found , <br/>Generate Job Suggestions with Ai 👇👇</div>}
      <CustomBtn
      ...
      >
        ✨{suggestions ? "ReGenerate Ai Based Job Suggestions":"Generate Ai Based Job Suggestions"}
      </CustomBtn>
      </main>
    </>
  );
