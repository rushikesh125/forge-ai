      ...
      <div className="text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -top-6 -right-6 w-12 h-12 bg-blue-500/10 rounded-full blur-xl" 
          />
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.3, duration: 0.5 }}
            className="absolute -bottom-4 -left-6 w-16 h-16 bg-purple-500/10 rounded-full blur-xl" 
          />
        </motion.div>
